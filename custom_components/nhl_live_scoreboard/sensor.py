...
def build_state_attributes(data: Any) -> dict[str, Any]:
    ...
    return {
        ...
        "next_game_start": data.next_game_start,
        "last_game_end": getattr(data, "last_game_end", None),
        "last_game_end_event_id": getattr(data, "last_game_end_event_id", ""),
        "last_game_end_source": getattr(data, "last_game_end_source", ""),
